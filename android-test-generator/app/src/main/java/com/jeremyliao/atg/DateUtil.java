...
public class DateUtil {
     ...
     * @return 时间戳
     */
    @TestCase(isStatic = true, checkReturn = true, inputs = "2017-10-15 16:00:02", expect = "1508054402000L")
     ...
     * 将时间戳转换为时间
     */
    @TestCase(isStatic = true, checkReturn = true, expect = "2017-10-15 16:00:02", inputs = "1508054402000L")
